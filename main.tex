...
\section{Markup (XAML)}
\MigrationNote{Phase 2: section is updated for Avalonia. Examples use \texttt{.axaml} and Avalonia XAML namespaces.}
...
\section{Code-behind}
\MigrationNote{Phase 2: section is updated for Avalonia. Example uses Avalonia event args and avoids \texttt{System.Windows.*}.}
...
\MigrationNote{Phase 2: section is updated for Avalonia + Rider. Replaces Visual Studio Properties/Designer workflow with XAML-first editing.}
...
\textbf{Napomena:} Avalonia nema WPF-ov "Properties" panel za događaje na isti način kao Visual Studio designer; u praksi se handler-i dodaju kroz XAML ili kod.

\section{Paneli (eng. Panels)}
\MigrationNote{Phase 2: panels section is largely identical between WPF and Avalonia; text is kept with minor wording updates.}
...
\MigrationNote{Phase 2: section is updated for Avalonia. Examples still use placeholders; they will be aligned to the new course project in a later step.}
